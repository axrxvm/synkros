module.exports = ({ sender, downloadLink, siteLink, size, expires }) => {
  ...
  <body class=""
    ...
    <span class="preheader"
      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Synkros - A file was shared with you.</span>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p
                          style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                          Thank you for using Synkros!</p>
                          <br>
                        <p
                          style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                          Regards, Team Synkros</p>
                      </td>
                    </tr>
                  </table>
                </td>
                ...
                <tr>
                  <td class="content-block powered-by"
                    ...
                    Powered by <a href="${siteLink}"
                      style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">Synkros</a>.
                  </td>
                </tr>
              </table>
            </div>
